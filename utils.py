...
def parameter_parser():
    ...
    return. args
        args.retdec_path : str
        args.input_path : str
        args.output_path : str
        args.classify : bool
    '''
    # update the description with your detector name
    parser = argparse.ArgumentParser(description="Run Opcode_graph_Detector.")
    
    parser.add_argument('-r', '--retdec-path', type=str, metavar='<path>',
                        help='path of retdec decompiler')
